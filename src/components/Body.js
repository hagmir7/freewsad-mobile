...
function Body(){
    ...
    return(
        <div className="col-md-8 col-lg-8 col-xl-6 p-3 mt-3 ">
            <div className="alert bg-white alert-dismissible fade show border" role="alert">
                <strong className='text-danger'>Like saving money?</strong> We search up to 200 sites to help you save up to 30%
